...
@XmlType(name = "ClearingSystemIdentification2Choice__1", namespace = "urn:iso:std:iso:20022:tech:xsd:pacs.009.001.08", propOrder = {
    "cd"
})
public class ClearingSystemIdentification2Choice1 {

    /**
     * Identification of a clearing system, in a coded
