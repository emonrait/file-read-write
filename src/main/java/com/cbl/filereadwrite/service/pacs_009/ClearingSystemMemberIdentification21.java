...
/**
 * Unique identification, as assigned by a clearing system,
 *                 to unambiguously identify a member of the clearing system.
 * 
 ...
 *         <element name="MmbId" type="{urn:iso:std:iso:20022:tech:xsd:pacs.009.001.08}HVPSPlus_RestrictedFINXMax28Text"/>
 *       </sequence>
 *     </restriction>
 *   </complexContent>
 * </complexType>
...
@XmlType(name = "ClearingSystemMemberIdentification2__1", namespace = "urn:iso:std:iso:20022:tech:xsd:pacs.009.001.08", propOrder = {
    "clrSysId",
    "mmbId"
})
public class ClearingSystemMemberIdentification21 {
     ...
     *                         clearing agents or the channel through which the payment instruction is processed.
     * 
     */
    @XmlElement(name = "ClrSysId", namespace = "urn:iso:std:iso:20022:tech:xsd:pacs.009.001.08", required = true)
    protected ClearingSystemIdentification2Choice1 clrSysId;
    /**
     * Identification of a member of a clearing
     *                         system.
     * 
     */
    @XmlElement(name = "MmbId", namespace = "urn:iso:std:iso:20022:tech:xsd:pacs.009.001.08", required = true)
