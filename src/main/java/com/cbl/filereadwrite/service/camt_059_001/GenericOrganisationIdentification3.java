 ...
 *         &lt;element name="SchmeNm" type="{urn:iso:std:iso:20022:tech:xsd:camt.059.001.08}OrganisationIdentificationSchemeName1Choice" minOccurs="0"/&gt;
...
@XmlType(name = "GenericOrganisationIdentification3", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.059.001.08", propOrder = {
    "id",
    "schmeNm",
    "issr"
})
