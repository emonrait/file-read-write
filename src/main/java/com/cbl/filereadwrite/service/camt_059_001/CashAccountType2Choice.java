 ...
 *       &lt;choice&gt;
 *         &lt;element name="Cd" type="{urn:iso:std:iso:20022:tech:xsd:camt.059.001.08}ExternalCashAccountType1Code"/&gt;
...
@XmlType(name = "CashAccountType2Choice", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.059.001.08", propOrder = {
    "cd",
    "prtry"
})
