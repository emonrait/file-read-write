 ...
 *       &lt;sequence&gt;
 *         &lt;element name="ClrSysId" type="{urn:iso:std:iso:20022:tech:xsd:camt.059.001.08}ClearingSystemIdentification2Choice" minOccurs="0"/&gt;
 *         &lt;element name="MmbId" type="{urn:iso:std:iso:20022:tech:xsd:camt.059.001.08}Max35Text"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlType(name = "ClearingSystemMemberIdentification2", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.059.001.08", propOrder = {
    "clrSysId",
    "mmbId"
})
public class ClearingSystemMemberIdentification2 {

    @XmlElement(name = "ClrSysId", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.059.001.08")
    protected ClearingSystemIdentification2Choice clrSysId;
    @XmlElement(name = "MmbId", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.059.001.08", required = true)
