 ...
 *       &lt;choice&gt;
 *         &lt;element name="Cd" type="{urn:iso:std:iso:20022:tech:xsd:camt.059.001.08}ExternalPersonIdentification1Code"/&gt;
...
@XmlType(name = "PersonIdentificationSchemeName1Choice", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.059.001.08", propOrder = {
    "cd",
    "prtry"
})
