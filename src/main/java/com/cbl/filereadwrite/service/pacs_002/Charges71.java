 ...
 *       <sequence>
 *         <element name="Amt" type="{urn:iso:std:iso:20022:tech:xsd:pacs.002.001.10}RestrictedFINActiveCurrencyAndAmount"/>
...
@XmlType(name = "Charges7__1", namespace = "urn:iso:std:iso:20022:tech:xsd:pacs.002.001.10", propOrder = {
    "amt",
    "agt"
})
public class Charges71 {
     ...
     * 
     */
    @XmlElement(name = "Amt", namespace = "urn:iso:std:iso:20022:tech:xsd:pacs.002.001.10", required = true)
    protected RestrictedFINActiveCurrencyAndAmount amt;
    /**
     * Agent that takes the transaction charges or to which the transaction charges are due.
     * 
     */
    @XmlElement(name = "Agt", namespace = "urn:iso:std:iso:20022:tech:xsd:pacs.002.001.10", required = true)
