...
@XmlType(name = "FinancialInstitutionIdentification18__2", namespace = "urn:iso:std:iso:20022:tech:xsd:pacs.002.001.10", propOrder = {
    "bicfi",
    "clrSysMmbId",
    "lei",
    "nm",
...
public class FinancialInstitutionIdentification182 {
     ...
     * 
     */
    @XmlElement(name = "BICFI", namespace = "urn:iso:std:iso:20022:tech:xsd:pacs.002.001.10", required = true)
