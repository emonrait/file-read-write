...
@XmlType(name = "OrganisationIdentification29__1", namespace = "urn:iso:std:iso:20022:tech:xsd:pacs.002.001.10", propOrder = {
    "anyBIC",
    "lei",
    "othr"
})
public class OrganisationIdentification291 {
     ...
     * 
     */
    @XmlElement(name = "AnyBIC", namespace = "urn:iso:std:iso:20022:tech:xsd:pacs.002.001.10")
