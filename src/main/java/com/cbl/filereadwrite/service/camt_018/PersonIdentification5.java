...
@XmlType(name = "PersonIdentification5", namespace = "urn:iso:std:iso:20022:tech:xsd:head.001.001.01", propOrder = {
    "dtAndPlcOfBirth",
    "othr"
})
public class PersonIdentification5 {

    @XmlElement(name = "DtAndPlcOfBirth", namespace = "urn:iso:std:iso:20022:tech:xsd:head.001.001.01")
