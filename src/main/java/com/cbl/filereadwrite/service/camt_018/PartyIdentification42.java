...
@XmlType(name = "PartyIdentification42", namespace = "urn:iso:std:iso:20022:tech:xsd:head.001.001.01", propOrder = {
    "nm",
    "pstlAdr",
    "id",
    "ctryOfRes",
...
public class PartyIdentification42 {
    ...
    protected String nm;
    @XmlElement(name = "PstlAdr", namespace = "urn:iso:std:iso:20022:tech:xsd:head.001.001.01")
    protected PostalAddress6 pstlAdr;
    @XmlElement(name = "Id", namespace = "urn:iso:std:iso:20022:tech:xsd:head.001.001.01")
    protected Party10Choice id;
    @XmlElement(name = "CtryOfRes", namespace = "urn:iso:std:iso:20022:tech:xsd:head.001.001.01")
    protected String ctryOfRes;
    @XmlElement(name = "CtctDtls", namespace = "urn:iso:std:iso:20022:tech:xsd:head.001.001.01")
