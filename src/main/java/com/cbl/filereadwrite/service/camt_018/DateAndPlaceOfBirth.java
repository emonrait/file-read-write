...
@XmlType(name = "DateAndPlaceOfBirth", namespace = "urn:iso:std:iso:20022:tech:xsd:head.001.001.01", propOrder = {
    "birthDt",
    "prvcOfBirth",
    "cityOfBirth",
    "ctryOfBirth"
...
public class DateAndPlaceOfBirth {
    ...
    @XmlElement(name = "BirthDt", namespace = "urn:iso:std:iso:20022:tech:xsd:head.001.001.01", required = true)
    @XmlSchemaType(name = "date")
    protected XMLGregorianCalendar birthDt;
    @XmlElement(name = "PrvcOfBirth", namespace = "urn:iso:std:iso:20022:tech:xsd:head.001.001.01")
    protected String prvcOfBirth;
    @XmlElement(name = "CityOfBirth", namespace = "urn:iso:std:iso:20022:tech:xsd:head.001.001.01", required = true)
    protected String cityOfBirth;
    @XmlElement(name = "CtryOfBirth", namespace = "urn:iso:std:iso:20022:tech:xsd:head.001.001.01", required = true)
