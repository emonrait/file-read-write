...
@XmlType(name = "ClearingSystemMemberIdentification2", namespace = "urn:iso:std:iso:20022:tech:xsd:head.001.001.01", propOrder = {
    "clrSysId",
    "mmbId"
})
public class ClearingSystemMemberIdentification2 {

    @XmlElement(name = "ClrSysId", namespace = "urn:iso:std:iso:20022:tech:xsd:head.001.001.01")
    protected ClearingSystemIdentification2Choice clrSysId;
    @XmlElement(name = "MmbId", namespace = "urn:iso:std:iso:20022:tech:xsd:head.001.001.01", required = true)
