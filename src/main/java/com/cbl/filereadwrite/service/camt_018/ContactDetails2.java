...
@XmlType(name = "ContactDetails2", namespace = "urn:iso:std:iso:20022:tech:xsd:head.001.001.01", propOrder = {
    "nmPrfx",
    "nm",
    "phneNb",
    "mobNb",
...
public class ContactDetails2 {
    ...
    @XmlElement(name = "NmPrfx", namespace = "urn:iso:std:iso:20022:tech:xsd:head.001.001.01")
    @XmlSchemaType(name = "string")
    protected NamePrefix1Code nmPrfx;
    @XmlElement(name = "Nm", namespace = "urn:iso:std:iso:20022:tech:xsd:head.001.001.01")
    protected String nm;
    @XmlElement(name = "PhneNb", namespace = "urn:iso:std:iso:20022:tech:xsd:head.001.001.01")
    protected String phneNb;
    @XmlElement(name = "MobNb", namespace = "urn:iso:std:iso:20022:tech:xsd:head.001.001.01")
    protected String mobNb;
    @XmlElement(name = "FaxNb", namespace = "urn:iso:std:iso:20022:tech:xsd:head.001.001.01")
    protected String faxNb;
    @XmlElement(name = "EmailAdr", namespace = "urn:iso:std:iso:20022:tech:xsd:head.001.001.01")
    protected String emailAdr;
    @XmlElement(name = "Othr", namespace = "urn:iso:std:iso:20022:tech:xsd:head.001.001.01")
