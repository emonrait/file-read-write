...
@XmlType(name = "FinancialInstitutionIdentification18__3", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.054.001.08", propOrder = {
    "bicfi",
    "clrSysMmbId",
    "lei",
    "nm",
...
public class FinancialInstitutionIdentification183 {
     ...
     * 
     */
    @XmlElement(name = "ClrSysMmbId", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.054.001.08")
