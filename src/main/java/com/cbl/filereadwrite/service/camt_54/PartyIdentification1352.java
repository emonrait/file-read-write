...
@XmlType(name = "PartyIdentification135__2", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.054.001.08", propOrder = {
    "nm",
    "pstlAdr",
    "id",
    "ctryOfRes",
...
public class PartyIdentification1352 {
     ...
     * 
     */
    @XmlElement(name = "CtctDtls", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.054.001.08")
