...
@XmlType(name = "PersonIdentification13__1", namespace = "urn:iso:std:iso:20022:tech:xsd:pacs.004.001.09", propOrder = {
    "dtAndPlcOfBirth",
    "othr"
})
public class PersonIdentification131 {
     ...
     * 
     */
    @XmlElement(name = "DtAndPlcOfBirth", namespace = "urn:iso:std:iso:20022:tech:xsd:pacs.004.001.09")
